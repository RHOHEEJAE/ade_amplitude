            ...
            expect(payload).toEqual({
              ...
              events: [
                ...
                },
                {
                  ...
                  event_properties: {
                    'page_domain': 'www.example.com',
                    'page_location': 'https://www.example.com/contact',
                    'page_path': '/contact',
                    'page_title': '',
                    'page_url': 'https://www.example.com/contact',
                    'page_view_id': uuid,
                    'previous_page_location': 'https://www.example.com/about',
                ...
                },
                {
                  ...
                  event_properties: {
                    'page_domain': 'www.example.com',
                    'page_location': 'https://www.example.com/more',
                    'page_path': '/more',
                    'page_title': '',
                    'page_url': 'https://www.example.com/more',
                    'page_counter': 1,
                    'page_view_id': uuid,
                    'previous_page_location': 'https://www.example.com/contact',
                    'previous_page_type': 'internal',
                  },
                  event_type: 'ade_page_viewed',
                  insert_id: uuid,
